Pod::Spec.new do |spec|
  ...
  spec.subspec 'TextNode2' do |text_node|
    ...
    text_node.dependency 'LRTexture/Core'
  end
  ...
  spec.subspec 'Video' do |video|
    ...
    video.dependency 'LRTexture/Core'
  end 
  ...
  spec.subspec 'Photos' do |photos|
    ...
    photos.dependency 'LRTexture/Core'
  end
  ...
  spec.subspec 'AssetsLibrary' do |assetslib|
    ...
    assetslib.dependency 'LRTexture/Core'
  end
